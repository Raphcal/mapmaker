...
public class TrajectoryPreview extends javax.swing.JDialog {
	...
	private static class Motion {
        ...
        private final float maximumFallSpeed;
		private final float acceleration;
		private final float weight;
		private final float jumpForce;
		private final float groundInfluence;
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(TrajectoryPreview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
