...
public class GenerateTileDialog extends javax.swing.JDialog {
	 ...
	 */
	public GenerateTileDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	}
    ...
    private void initComponents() {
        ...
        grid1 = new fr.rca.mapmaker.ui.Grid();
	...
	public static void main(String args[]) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				GenerateTileDialog dialog = new GenerateTileDialog(new javax.swing.JFrame(), true);
    ...
    private fr.rca.mapmaker.ui.Grid grid1;
