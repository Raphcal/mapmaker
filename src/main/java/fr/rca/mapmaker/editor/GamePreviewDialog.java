...
public class GamePreviewDialog extends javax.swing.JDialog {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(GamePreviewDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				GamePreviewDialog dialog = new GamePreviewDialog(new javax.swing.JFrame(), true);
